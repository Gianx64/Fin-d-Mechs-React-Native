...
export async function createAppointment(user, date, city, address, car_make, car_model, description, service, workshop_id, mech) {
  try {
  ...
  if (currentUser.$mech) {
    try {
      const appointments = await databases.listDocuments(
        appwriteConfig.databaseId,
        appwriteConfig.appointmentCollectionId,
        [Query.equal("mech", currentUser.$email)]
      );
